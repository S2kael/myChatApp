    ...
    return function (e) {
        ...
        return r.m = e, r.c = h, r.d = function (a, t, e) {
            ...
            if (r.r(e), Object.defineProperty(e, "default", {
                enumerable: !0,
                value: t
            }), 2 & a && "string" != typeof t) for (var h in t) r.d(e, h, function (a) {
                return t[a]
            }.bind(null, h));
            return e
        }, r.n = function (a) {
...
*/
                ...
                var a = function () {
                    ...
                    function r(a, t) {
                        if (t) {
                            ...
                            }(a, t) : Array.isArray(t) ? g(a, t) : "object" === e ? function (a, t) {
            ...
            a.exports = function (e) {
                ...
                return i.toString = function () {
                    return this.map(function (a) {
                        var t = function (a, t) {
                            ...
                            if (t && "function" == typeof btoa) {
                                var r = (i = h, "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */"),
                    ...
                    for (h = 0; h < a.length; h++) {
                        var d = a[h];
                        "number" == typeof d[0] && e[d[0]] || (t && !d[2] ? d[2] = t : t && (d[2] = "(" + d[2] + ") and (" + t + ")"), i.push(d))
                    }
                }, i
            }
  ...
  \****************************************************/
        /*! no static exports found */function (a, t, e) {
            var h, r, d, n = {}, o = (h = function () {
                return window && document && document.all && !window.atob
            }, function () {
                return void 0 === r && (r = h.apply(this, arguments)), r
            }), i = (d = {}, function (a) {
                ...
                return d[a]
            }), l = null, c = 0, g = [], p = e(/*! ./urls */"./node_modules/style-loader/lib/urls.js");
            ...
            function m(a, t) {
                for (var e = 0; e < a.length; e++) {
                    ...
                    if (r) {
                        r.refs++;
                        for (var d = 0; d < r.parts.length; d++) r.parts[d](h.parts[d]);
                        for (; d < h.parts.length; d++) r.parts.push(L(h.parts[d], t))
                    } else {
                        var i = [];
                        for (d = 0; d < h.parts.length; d++) i.push(L(h.parts[d], t));
                        n[h.id] = {id: h.id, refs: 1, parts: i}
                    }
                }
            }

            function y(a, t) {
                for (var e = [], h = {}, r = 0; r < a.length; r++) {
                    var d = a[r], i = t.base ? d[0] + t.base : d[0], g = {css: d[1], media: d[2], sourceMap: d[3]};
                    h[i] ? h[i].parts.push(g) : e.push(h[i] = {id: i, parts: [g]})
                }
                return e
            }

            function z(a, t) {
                var e = i(a.insertInto);
                if (!e) throw new Error("Couldn't find a style target. This probably means that the value for the 'insertInto' parameter is invalid.");
                var h = g[g.length - 1];
                if ("top" === a.insertAt) h ? h.nextSibling ? e.insertBefore(t, h.nextSibling) : e.appendChild(t) : e.insertBefore(t, e.firstChild), g.push(t); else if ("bottom" === a.insertAt) e.appendChild(t); else {
            ...
            function M(a) {
                ...
                return void 0 === a.attrs.type && (a.attrs.type = "text/css"), s(t, a.attrs), z(a, t), t
            }
            ...
            function L(t, a) {
                ...
                if (a.transform && t.css) {
                    if (!(d = a.transform(t.css))) return function () {
                    };
                    t.css = d
                }
                if (a.singleton) {
                    var n = c++;
                    e = l || (l = M(a)), h = A.bind(null, e, n, !1), r = A.bind(null, e, n, !0)
                } else r = t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (i = a, g = document.createElement("link"), void 0 === i.attrs.type && (i.attrs.type = "text/css"), i.attrs.rel = "stylesheet", s(g, i.attrs), z(i, g), h = function (a, t, e) {
                    var h = e.css, r = e.sourceMap, d = void 0 === t.convertToAbsoluteUrls && r;
                    (t.convertToAbsoluteUrls || d) && (h = p(h));
                    r && (h += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(r)))) + " */");
                    var i = new Blob([h], {type: "text/css"}), g = a.href;
                    a.href = URL.createObjectURL(i), g && URL.revokeObjectURL(g)
                }.bind(null, e = g, a), function () {
                    v(e), e.href && URL.revokeObjectURL(e.href)
                }) : (e = M(a), h = function (a, t) {
                    var e = t.css, h = t.media;
                    h && a.setAttribute("media", h);
            ...
            a.exports = function (a, i) {
                ...
                (i = i || {}).attrs = "object" == typeof i.attrs ? i.attrs : {}, i.singleton || "boolean" == typeof i.singleton || (i.singleton = o()), i.insertInto || (i.insertInto = "head"), i.insertAt || (i.insertAt = "bottom");
                var g = y(a, i);
                return m(g, i), function (a) {
                    for (var t = [], e = 0; e < g.length; e++) {
                        var h = g[e];
                        (r = n[h.id]).refs--, t.push(r)
                    }
                    a && m(y(a, i), i);
            ...
            var w, u = (w = [], function (a, t) {
                return w[a] = t, w.filter(Boolean).join("\n")
            });

            function A(a, t, e, h) {
                var r = e ? "" : h.css;
                if (a.styleSheet) a.styleSheet.cssText = u(t, r); else {
                    var d = document.createTextNode(r), i = a.childNodes;
                    i[t] && a.removeChild(i[t]), i.length ? a.insertBefore(d, i[t]) : a.appendChild(d)
                }
            }
  ...
  \***********************************************/
        /*! no static exports found */function (a, t) {
            a.exports = function (a) {
                ...
                var r = t.protocol + "//" + t.host, d = r + t.pathname.replace(/\/[^\/]*$/, "/");
                return a.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (a, t) {
                    var e, h = t.trim().replace(/^"(.*)"$/, function (a, t) {
                        return t
                    }).replace(/^'(.*)'$/, function (a, t) {
                        return t
                    });
                    return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(h) ? a : (e = 0 === h.indexOf("//") ? h : 0 === h.indexOf("/") ? r + h : d + h.replace(/^\.\//, ""), "url(" + JSON.stringify(e) + ")")
                })
            }
  ...
  \************************************/
        /*! no static exports found */function (a, t, e) {
            ...
            "string" == typeof h && (h = [[a.i, h, ""]]);
            var r = {hmr: !0, transform: void 0, insertInto: void 0};
            e(/*! ../../node_modules/style-loader/lib/addStyles.js */"./node_modules/style-loader/lib/addStyles.js")(h, r);
            h.locals && (a.exports = h.locals)
  ...
  \*****************************/
        /*! exports provided: default */function (a, t, e) {
            "use strict";
            e.r(t);
            var h = e(/*! classnames/dedupe */"./node_modules/classnames/dedupe.js"), n = e.n(h),
            ...
            function l(t) {
                for (var a = 1; a < arguments.length; a++) {
                    var e = null != arguments[a] ? arguments[a] : {}, h = Object.keys(e);
             ...
             * Licensed under the MIT License. See License.txt in the project root for license information.
             */
            var c = {hover: !0}, p = function (a) {
                return "string" == typeof a || a instanceof String
            }, g = function () {
                function e(a, t) {
                    !function (a, t) {
                        if (!(a instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, e), this.name = a, this.contents = t, this.attrs = l({}, r, {class: "eva eva-".concat(a)})
                }

                var a, t, h;
                return a = e, (t = [{
                    key: "toSvg", value: function () {
                        var t, a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, e = a.animation,
                            h = o(a, ["animation"]), r = function (a) {
                                if (!a) return null;
                            ...
                            i = l({}, this.attrs, h, {class: n()(this.attrs.class, a.class, d)}),
                            g = "<svg ".concat((t = i, Object.keys(t).map(function (a) {
                                return "".concat(a, '="').concat(t[a], '"')
                            }).join(" ")), ">").concat(this.contents, "</svg>");
                        return r && r.hover ? '<i class="eva-hover">'.concat(g, "</i>") : g
                    }
                }, {
                    key: "toString", value: function () {
                        return this.contents
                    }
                }]) && i(a.prototype, t), h && i(a, h), e
            }();
            t.default = g
  ...
  \******************************/
        /*! exports provided: icons, replace */function (a, t, e) {
            ...
            e(/*! ./animation.scss */"./package/src/animation.scss")
  ...
  \********************************/
        /*! exports provided: default */function (a, t, e) {
            "use strict";
            e.r(t);
            var h = e(/*! classnames/dedupe */"./node_modules/classnames/dedupe.js"), c = e.n(h),
            ...
            var v = {"data-eva-animation": "type", "data-eva-hover": "hover", "data-eva-infinite": "infinite"}, M = {
                "data-eva": "name",
                    ...
                    return function (a) {
                        var t, e, h, r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                            d = (h = a, Array.from(h.attributes).reduce(function (a, t) {
                                var e;
                                return v[t.name] ? a.animation = m({}, a.animation, y({}, v[t.name], t.value)) : a = m({}, a, M[(e = t).name] ? y({}, M[e.name], e.value) : y({}, e.name, e.value)), a
                            }, {})), i = d.name, g = z(d, ["name"]),
                            n = p.default[i].toSvg(m({}, r, g, {animation: (t = r.animation, e = g.animation, t || e ? m({}, t, e) : null)}, {class: c()(r.class, g.class)})),
